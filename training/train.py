...
Wires together the three pipeline steps:
  ...
  Step 1  training/adapters/google_cluster.py  CSV  →  cluster_agg.parquet
  Step 2  spike/feature_engineer.py           agg  →  cluster_features.parquet
  Step 3  spike/classifier.py                 feat →  spike_model.json + artefacts
...
Usage (from repo root):
    python training/train.py --data-path data/cluster_cpu_data.csv
    python training/train.py --data-path data/cluster_cpu_data.csv --force
    python training/train.py --data-path data/cluster_cpu_data.csv --from-step 3
    python training/train.py --data-path data/cluster_cpu_data.csv --no-walk-forward
"""
...
from training.adapters.google_cluster import preprocess
